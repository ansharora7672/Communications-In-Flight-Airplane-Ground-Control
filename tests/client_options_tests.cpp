...
TEST(ClientOptionsTest, DefaultsUseLocalhostDefaultPortAndAutoId) {
    // CLT-UT-009, REQ-CLT-020: Default CLI options auto-assign a valid aircraft ID.
...
TEST(ClientOptionsTest, ParsesCustomHostPortAndAircraftId) {
    // CLT-UT-010, REQ-CLT-020: Explicit CLI aircraft IDs are preserved after validation.
...
TEST(ClientOptionsTest, RejectsOutOfRangePort) {
    // CLT-UT-011, REQ-CLT-020: Client option parsing rejects invalid TCP port values.
...
TEST(ClientOptionsTest, RejectsMalformedExplicitAircraftId) {
    // CLT-UT-012, REQ-CLT-020: Client option parsing rejects malformed explicit IDs.
